...
// La URL base de tu backend. Asegúrate de que el backend esté corriendo.
// Si React y Node corren en puertos diferentes, necesitarás configurar CORS en tu backend (Express).
